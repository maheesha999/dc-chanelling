      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        <div className="flex items-center gap-4 mb-8 text-grey-500">
          <label htmlFor="doc-img">
            <img
              className="w-16 bg-grey-100 rounded-full cursor-pointer"
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-grey-600">
        ...
        <button
          type="submit"
          className="bg-[#29AB87] px-10 py-3 mt-4 text-white rounded-full"
        >
          Add Doctor
        </button>
      </div>
