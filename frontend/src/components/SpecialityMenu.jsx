...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
      ...
      <p className='sm:w-1/3 text-center text-sm'>Browse our extensive list of trusted Ayurvedic doctors, find the nearest specialist, and book your appointment hassle-free.</p>
